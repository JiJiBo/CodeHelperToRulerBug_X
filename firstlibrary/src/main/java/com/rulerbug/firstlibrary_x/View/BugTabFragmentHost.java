package com.rulerbug.firstlibrary_x.View;
 ...
 */
public class BugTabFragmentHost extends TabHost implements
	...
	public BugTabFragmentHost(Context context) {
	...
	public BugTabFragmentHost(Context context, AttributeSet attrs) {
		super(context, attrs);
