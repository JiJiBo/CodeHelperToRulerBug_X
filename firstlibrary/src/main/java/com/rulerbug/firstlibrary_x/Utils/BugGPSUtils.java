...
public class BugGPSUtils {
    private static String TAG = BugGPSUtils.class.getSimpleName();
    private static BugGPSUtils mInstance;
    ...
    private BugGPSUtils(Context context) {
        this.mContext = context;
    }

    public static BugGPSUtils getInstance(Context context) {
        if (mInstance == null) {
            mInstance = new BugGPSUtils(context.getApplicationContext());
        }
        return mInstance;
    }
