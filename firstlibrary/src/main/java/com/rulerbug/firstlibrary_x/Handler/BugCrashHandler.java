package com.rulerbug.firstlibrary_x.Handler;
...
import com.rulerbug.firstlibrary_x.Utils.BugDirUtils;
 ...
 * 处理异常
 */
public class BugCrashHandler implements UncaughtExceptionHandler {
    Context mcontext;
    // 用来存储设备信息和异常信息
    ...
    protected String getRootPath() {
        return BugDirUtils.getDirPathByDirName(dirName);
    }
    ...
    public static BugCrashHandler getInstance() {
        if (INSTANCE == null) {
            return INSTANCE = new BugCrashHandler();
        } else {
            return INSTANCE;
        }
    }
